...
## ---- echo = F, out.width = "75%"-------------------------------------------------------------------------------------------------------------------------------
include_graphics("figures/broadbalk.jpg")
...
## ---- echo = F, out.width = "85%"-------------------------------------------------------------------------------------------------------------------------------
 include_graphics("figures/pcb.jpg")


## ----causal, echo = F, fig.show='hold', out.width="75%", fig.align='center'-------------------------------------------------------------------------------------
library(igraph)
...
## ----causalR, echo = F, fig.show='hold', out.width="75%", fig.align='center'------------------------------------------------------------------------------------
...
## ---- fig.show='hold', out.width = "100%", fig.align = 'center'-------------------------------------------------------------------------------------------------
library(FrF2)
...
## ---- echo = F, out.width = "85%"-------------------------------------------------------------------------------------------------------------------------------
 include_graphics("figures/bacteriocin.jpg")
...
## ----ssdshrink, echo = F, out.width="50%", fig.align='center'---------------------------------------------------------------------------------------------------
include_graphics("figures/ssd_profile.jpg")


## ----compcode, echo = F, out.width="75%", fig.align='center'----------------------------------------------------------------------------------------------------
...
## ----lhs2, fig.show='hold', echo = F, out.width = "33%"---------------------------------------------------------------------------------------------------------
...
## ----gpsimpex, fig.align='center', echo = F---------------------------------------------------------------------------------------------------------------------
library(DiceDesign)
library(DiceKriging)
xi <- lhsDesign(6, 1)$design
y <- sin(2 * pi * xi)
