...
What do you think will have happened to the alias structure of the new design? Use <tt>design.info()$aliased</tt> or the <tt>alias</tt> function to check your intuition.
