...
(Hint - the model formula should be something like <tt>y ~ (x1 + x2 + x3 + x4 + x5)^2 + (x1 + x2 | wp)</tt>, where <tt>wp</tt> is a column identifying the different whole plots in the experiment).
