...
```{r completefoldover}
    ...
    q1b.design
```
Previously, $x_1 = x_8x_9$ (for example); now, for half the design $x_1 = x_8x_9$, and for the other half $x_1 = -x_8x_9$. Therefore, for the whole design the aliasing is broken (knowing the value of $x_1$ no longer determines the value of $x_8x_9$). We can check this using <tt>design.info(q1b.design)$aliased</tt><tt>alias</tt>:
```{r completefoalias}
